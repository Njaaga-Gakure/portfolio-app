    ...
    <main>
      <section className="hero">
        <div className="hero-center">
          ...
          Passionate self-taught JavaScript developer adept at both front-end and back-end development. Eager to contribute to impactful projects and enhance professional skills. Open to opportunities from potential employers. Let's connect!
          </p>
